...
Il ne remplace pas les statuts, règlements intérieurs, procès-verbaux ou documents juridiques signés.
...
## Dépôts de l’organisation `acorsica`

| Dépôt | Fonction | Statut |
|---|---|---|
| [`acorsica/.github`](https://github.com/acorsica/.github) | Profil public GitHub de l’organisation | Présentation publique |
...
| Dépôt | Fonction | Document de liaison |
|---|---|---|
| [`JeanHuguesRobert/JeanHuguesRobert`](https://github.com/JeanHuguesRobert/JeanHuguesRobert) | Point d’entrée personnel du corpus | [`acorsica-et-corpus.md`](https://github.com/JeanHuguesRobert/JeanHuguesRobert/blob/main/acorsica-et-corpus.md) |
| [`JeanHuguesRobert/barons-Mariani`](https://github.com/JeanHuguesRobert/barons-Mariani) | Futur fonds Barons Mariani, Musée Mariani des Possibles, corpus patrimonial | [`acorsica-institut-mariani.md`](https://github.com/JeanHuguesRobert/barons-Mariani/blob/main/acorsica-institut-mariani.md) |
| [`JeanHuguesRobert/cogentia`](https://github.com/JeanHuguesRobert/cogentia) | Cogentia, Cogentigrams, continuations, jumeaux numériques | [`acorsica-institut-mariani.md`](https://github.com/JeanHuguesRobert/cogentia/blob/main/acorsica-institut-mariani.md) |
| [`JeanHuguesRobert/inseme`](https://github.com/JeanHuguesRobert/inseme) | Infrastructure civique multi-instance | [`acorsica-institut-mariani.md`](https://github.com/JeanHuguesRobert/inseme/blob/main/acorsica-institut-mariani.md) |
| [`JeanHuguesRobert/marenostrum`](https://github.com/JeanHuguesRobert/marenostrum) | MareNostrum, DHITL, souveraineté énergétique et compute | [`acorsica-institut-mariani.md`](https://github.com/JeanHuguesRobert/marenostrum/blob/main/acorsica-institut-mariani.md) |
| [`JeanHuguesRobert/FractaVolta`](https://github.com/JeanHuguesRobert/FractaVolta) | Future SAS à impact | [`acorsica-institut-mariani.md`](https://github.com/JeanHuguesRobert/FractaVolta/blob/main/acorsica-institut-mariani.md) |
...
Des traductions ou adaptations peuvent être produites comme produits déclinés, sans remplacer la version française sauf mention explicite contraire.
